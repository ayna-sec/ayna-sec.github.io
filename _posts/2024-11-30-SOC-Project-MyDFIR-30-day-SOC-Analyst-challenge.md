...
# Attack on Windows Server - C2 Server and Data Exfiltration
## Attack diagram
...
# Alerts and Dashboards for Mythic Activity
...
    "message": """data:text/html,Please investigate the alert generated by <b>{{rule.name}}</b>. ---
Description: <i>{{context.rule.description}}</i> ---
Link: <b><u>{{rule.url}}</u></b>"""
}
```
...
# Elastic Defend Setup & Response Action
...
If you read until here, first, thank you for your attention. And second, please, don't hesitate to share your thoughts with me on [Linkedin](https://www.linkedin.com/in/angie-yuliana-naranjo/){: .btn .btn--success}.
